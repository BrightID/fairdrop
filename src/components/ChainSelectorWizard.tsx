        ...
        switch (step) {
          case WizardSteps.SigningMessage:
            setStepInfo({
              ...
              description:
                'Prove ownership of address by accepting the signature ' +
          ...
          case WizardSteps.Success:
            setStepInfo({
              message: 'Success',
              description: `The payout chain has been changed to ${chainName(
                desiredChainId
              )}.`,
            });
            break;
