...
const AddressRegistrationController = ({address, brightIdLinked, registrationInfo, registrationInfoLoading, payoutChainId, nextAmount }: AddressRegistrationControllerProps) => {
