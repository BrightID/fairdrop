    ...
    const mainContent = (
        <Grid item>
            <Typography align={'left'} variant={'h4'}>
                We are currently preparing the next airdrop phase. During this time claiming
                is not possible.
            </Typography>
            <CountDown title={'Next claim period starts in'} timestamp={registrationInfo.nextClaimStart}/>
        </Grid>
    )
